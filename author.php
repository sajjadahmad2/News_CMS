      ...
      <div class="container">
        <div class="row">
            ...
            <div class="post-container">
                <?php
                  $auid=$_GET['authid'];
                  $sql="select * from user where user_id=$auid";
                  ...
                  <?php
                        ...
                        $offset=($page-1)*$limit;
                        $sql="select * from post left join category on post.category=category.category_id left join user on post.author=user.user_id where user.user_id =$auid order by post.post_id limit $offset,$limit";
                        $result=mysqli_query($link,$sql);
                        ...
                        <?php }
                  $sql="select * from post where author =$auid";
                  $result=mysqli_query($link,$sql);
                  ...
                  echo"<ul class='pagination admin-pagination'>";
...

                    {
                        ...
                        echo '<li class="'.$active.'"><a href="author.php?authid='.$auid.'& page='.$i.'">'.$i.'</a></li>';
                    }
